// ==UserScript==
// @name         RSS Radar : Show All RSS of Websites and Pages (If Any)
...
// @description         Show All RSS of Websites and Pages (If Any)
// @description:zh      显示网站或者页面上所有的 RSS（如果有）
// @description:zh-CN   显示网站或者页面上所有的 RSS（如果有）
// @description:zh-TW   顯示網站上所有的 RSS（如果有）
...
// @author       github.com/rkspp
// @supportURL   https://github.com/rkspp/rss-radar-script/issues
// @match        http://*/*
// @match        https://*/*
